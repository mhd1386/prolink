...
class TelegramBot:
    ...
    async def edit_message(self, chat_id: int, message_id: int, text: str, **kwargs) -> Message:
        ...
        try:
            ...
            logging.error(f"خطا در ویرایش پیام {message_id} در {chat_id}: {e}")
            raise
    ...
    async def delete_message(self, chat_id: int, message_id: int):
        ...
        try:
            ...
            logging.error(f"خطا در حذف پیام {message_id} از {chat_id}: {e}")
    ...
    async def send_document(self, chat_id: int, document, **kwargs) -> Message:
        ...
        try:
            ...
            logging.error(f"خطا در ارسال فایل به {chat_id}: {e}")
            raise

# برای جلوگیری از circular import
import logging
